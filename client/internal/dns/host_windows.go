...
func (r *registryConfigurator) addDNSMatchPolicy(domains []string, ip netip.Addr) (int, error) {
	...
	log.Infof("added %d separate NRPT entries", len(domains))
...
func (r *registryConfigurator) removeDNSMatchPolicies() error {
	return r.removeDNSMatchPoliciesWithCount(r.nrptEntryCount)
}

func (r *registryConfigurator) removeDNSMatchPoliciesWithCount(count int) error {
	var merr *multierror.Error
